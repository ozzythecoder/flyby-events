import { type AnyPgColumn, varchar, unique, text, timestamp, boolean, pgEnum, pgTable, uuid } from 'drizzle-orm/pg-core';
import { InferSelectModel, relations } from 'drizzle-orm';

export const guestStatusEnum = pgEnum('guest_state', ['none', 'going', 'not going', 'maybe']);
...
export const commentsRelation = relations(comments, ({ one }) => ({
  ...
  replyTo: one(comments, { fields: [comments.replyToId], references: [comments.id] }),
}))

export const eventGuests = pgTable('eventGuests', {
